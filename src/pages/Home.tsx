...
export default function Home() {
  ...
  return (
    <div className="min-h-screen transition-colors duration-300">
      ...
      <section className="relative pt-32 pb-0 overflow-hidden transition-colors duration-300">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <WordReveal
              ...
              className="text-4xl md:text-5xl lg:text-6xl font-bold text-forest mt-6 mb-12 leading-tight tracking-tight"
              as="h3"
            />
      ...
      {/* Trusted By Section */}
      <section className="pt-0 pb-32 bg-background-light transition-colors duration-300">
