    ...
    <div className="min-h-screen">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
          <div className="max-w-4xl mx-auto">
            ...
            <ScrollReveal variant="fadeIn">
              <nav className="flex items-center gap-2 text-sm text-[rgb(94,107,100)] mb-6">
                <Link to="/" className="hover:text-[rgb(19,38,27)] transition">Home</Link>
                <span>/</span>
                <Link to="/projects" className="hover:text-[rgb(19,38,27)] transition">Projects</Link>
                <span>/</span>
                <span className="text-[rgb(19,38,27)]">Eco Savaari</span>
              </nav>
            </ScrollReveal>
            ...
            <StaggerContainer>
              <StaggerItem>
                <div className="flex items-center gap-3 mb-6">
                  <span className="text-sm font-semibold text-[rgb(238,185,42)] uppercase tracking-wide">
                    Wildlife
                  </span>
              ...
              <StaggerItem>
                <p className="text-2xl text-[rgb(94,107,100)] font-medium">
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="prose prose-lg max-w-none">
            ...
            <ScrollReveal variant="slideUp" delay={0.4}>
              <p className="text-lg text-[rgb(19,38,27)] leading-relaxed mb-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  {[
                    ...
                    >
                      ...
                      <div>
                        <h4 className="font-bold text-[rgb(19,38,27)] mb-2">{feature.title}</h4>
                        <p className="text-[rgb(94,107,100)]">{feature.description}</p>
                      </div>
                    </motion.div>
                  ))}
                </div>
              ...
              <ScrollReveal key={index} variant="scaleIn" delay={index * 0.1}>
                <div className="text-center">
                  <motion.div
                    ...
                    className="text-5xl md:text-6xl font-bold mb-2 text-[rgb(238,185,42)]"
                  >
                    {stat.number}
                  </motion.div>
      ...
      <section className="py-20 bg-[rgb(243,235,212)]">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <ScrollReveal variant="slideUp" delay={0.2}>
            <p className="text-xl text-[rgb(19,38,27)] mb-8">
          ...
          <ScrollReveal variant="slideUp" delay={0.4}>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <motion.div variants={buttonHover} initial="rest" whileHover="hover" whileTap="tap">
                <Link
                  to="/contact"
                  className="inline-block px-8 py-4 bg-[rgb(238,185,42)] text-[rgb(19,38,27)] rounded-lg hover:bg-[#3551B4] hover:text-white transition text-lg font-semibold shadow-lg"
                >
                  Get Involved
                </Link>
              </motion.div>
